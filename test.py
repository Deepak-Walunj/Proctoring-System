...
class FacePreprocessing:
        ...
        try:
            ...
            if result_facePoint.multi_face_landmarks:
                for face_landmarks in result_facePoint.multi_face_landmarks:
                    ...
                    toast=text
                        # cv.putText(face, text, (top_left_x, top_left_y + int(height * 0.20)), cv.FONT_HERSHEY_SIMPLEX, font_scale, (0, 255, 0), thickness)
                    ...
                    return face, looking_straight_status, toast
            else:
    ...
    def detect_faces(self, face, result_faceDetection):
        ...
        try:
            ...
            # rgb_frame = cv.cvtColor(face, cv.COLOR_BGR2RGB)
            # try:
    ...
    def detect_landmarks(self, face, result_facePoints):
        ...
        try:
            ...
            if h != w:
                ...
                h, w = size, size
            # try:
            #     rgb_face = cv.cvtColor(face, cv.COLOR_BGR2RGB)
...
def main(cap, face_preprocessor):
    ...
    while cap.isOpened():
        ...
        frame, looking_straight_status, gaze_toast=obj.gaze(frame, result_facePoints)
