...
class ObjectDetectionModule:
    ...
    def __init__(self, model_path=None, score_threshold=0.3):
        if model_path is None:
            model_path = "C:\efficientdet.tflite"
    ...
    def detect_cheating(self, frame):
        ...
        for obj in list(self.previous_objects.keys()):
            if obj not in detected_labels:
                ...
                if self.previous_objects[obj][1] > 20:  # If object disappears for more than 3 frames
                    objects_to_remove.append(obj)
        # Remove objects that disappeared too long
        for obj in objects_to_remove:
            del self.previous_objects[obj]
        # Update object count only when the object first appears
        for obj in detected_labels:
            if self.previous_objects[obj][0] == 1:  # First appearance in this session
...
if __name__ == "__main__":
    ...
    if cond:
        ...
        while True:
            ...
            # Print the number of actual appearances
            print(toast)
