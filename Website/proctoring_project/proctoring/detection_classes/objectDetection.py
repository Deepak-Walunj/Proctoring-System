...
class ObjectDetectionModule:
    ...
    def _initialize_detector(self, model_path, score_threshold):
        ...
        if not os.path.exists(model_path):
            # return None, self.cheating_status, self.object_count, f"Model file not found at {model_path}"
            raise ValueError(f"Model file not found at {model_path}")
    ...
    def detect_cheating(self, frame):
        ...
        try:
            ...
            return frame, self.cheating_status, self.object_count, toast 
